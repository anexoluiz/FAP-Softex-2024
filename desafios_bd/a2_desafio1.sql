...
# Inserindo as tarefas para cada membro
INSERT INTO
    tarefas (
        tarefa_id,
        descricao,
...
VALUES
    (
        NULL,
        'Analisar requisitos novo projeto',
        '2024-06-19',
        '2024-06-30',
        3
    );
...
VALUES
    (
        NULL,
        'Desenvolver funcionalidades sistema',
        '2024-06-20',
        '2024-07-01',
        4
    );
...
VALUES
    (
        NULL,
        'Otimizar consultas SQL desempenho',
        '2024-06-21',
        '2024-07-02',
        5
    );
...
VALUES
    (
        NULL,
        'Arquitetar estrutura novo módulo',
        '2024-06-22',
        '2024-07-03',
        6
    );
...
VALUES
    (
        NULL,
        'Revisão código padrões qualidade',
        '2024-06-23',
        '2024-07-04',
        7
    );
...
VALUES
    (
        NULL,
        'Configurar switches expansão rede',
        '2024-06-24',
        '2024-07-05',
        8
    );
# Corrigindo o sexo dos membros 3 e 7
UPDATE membros SET genero = 'M' WHERE membro_id = 7 OR membro_id = 3;
